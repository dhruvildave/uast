...
function iastToUAST(data: string): string {
	...
	for (let i = 0; i < str.length; ) {
		...
		if (devanagariCharDict.vowels.has(curr) && devanagariCharDict.consonants.has(next)) {
			arr.push(`${curr}\\`);
			i++;
			continue;
		}
...
type Builder = {
	[k in LangList]: {
		[f in FuncList]: ReturnType<
			typeof createDataFunction & typeof createHandleUnicode & typeof createScriptFunction
		>;
	};
};
...
export const convertor: {
	...
	uast: {
		...
		devanagari: [builderFuncs["sa"]["handleUnicode"], builderFuncs["sa"]["dataFunction"]],
		gu: [builderFuncs["gu"]["handleUnicode"], builderFuncs["gu"]["dataFunction"]],
		or: [builderFuncs["or"]["handleUnicode"], builderFuncs["or"]["dataFunction"]],
		kn: [builderFuncs["kn"]["handleUnicode"], builderFuncs["kn"]["dataFunction"]],
		te: [builderFuncs["te"]["handleUnicode"], builderFuncs["te"]["dataFunction"]],
		ml: [builderFuncs["ml"]["handleUnicode"], builderFuncs["ml"]["dataFunction"]],
		ta: [builderFuncs["ta"]["handleUnicode"], builderFuncs["ta"]["dataFunction"]]
	},
	raw: {
	...
	devanagari: {
		...
		gu: [devanagariToUAST, builderFuncs["gu"]["handleUnicode"], builderFuncs["gu"]["dataFunction"]],
		or: [devanagariToUAST, builderFuncs["or"]["handleUnicode"], builderFuncs["or"]["dataFunction"]],
		kn: [devanagariToUAST, builderFuncs["kn"]["handleUnicode"], builderFuncs["kn"]["dataFunction"]],
		te: [devanagariToUAST, builderFuncs["te"]["handleUnicode"], builderFuncs["te"]["dataFunction"]],
		ml: [devanagariToUAST, builderFuncs["ml"]["handleUnicode"], builderFuncs["ml"]["dataFunction"]],
		ta: [devanagariToUAST, builderFuncs["ta"]["handleUnicode"], builderFuncs["ta"]["dataFunction"]]
	},
	iast: {
		uast: [iastToUAST],
		devanagari: [
		...
		gu: [iastToUAST, builderFuncs["gu"]["handleUnicode"], builderFuncs["gu"]["dataFunction"]],
		or: [iastToUAST, builderFuncs["or"]["handleUnicode"], builderFuncs["or"]["dataFunction"]],
		kn: [iastToUAST, builderFuncs["kn"]["handleUnicode"], builderFuncs["kn"]["dataFunction"]],
		te: [iastToUAST, builderFuncs["te"]["handleUnicode"], builderFuncs["te"]["dataFunction"]],
		ml: [iastToUAST, builderFuncs["ml"]["handleUnicode"], builderFuncs["ml"]["dataFunction"]],
		ta: [iastToUAST, builderFuncs["ta"]["handleUnicode"], builderFuncs["ta"]["dataFunction"]]
	},
	gu: {
